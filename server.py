"""
arrstack-mcp — MCP server for Sonarr, Radarr, Lidarr, Prowlarr, qBittorrent & Jellyfin.
...
def main():
    parser = argparse.ArgumentParser(
        description="arrstack-mcp — MCP server for Sonarr, Radarr, Lidarr, qBittorrent & Jellyfin"
    )
    parser.add_argument(
        "--transport",
    ...
    if not enabled:
        print(
            ...
            "SONARR_URL, RADARR_URL, LIDARR_URL, QBT_URL, JELLYFIN_URL",
            file=sys.stderr,
        )
        sys.exit(1)
